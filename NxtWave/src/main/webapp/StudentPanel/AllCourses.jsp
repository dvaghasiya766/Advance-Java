...
<div class="remaining-width">
	<div class="container-fluid p-0 mb-4">
		<div class="row align-items-center">
			<div class="col-md-6">
				<h2 class="fw-bold mb-0 darkBlueText heading-1">Enroll Another Course!</h2>
									...
									<div class="card h-100 border-1 shadow-sm">
										...
										<div class="card-body px-3 pb-3">
											...
											<div class="d-flex align-items-center mb-2">
												...
												<span class="text-primary fw-medium text-truncate d-inline-block"
													style="font-size: 1rem; max-width: 180px;" data-bs-toggle="tooltip"
													data-bs-placement="top" title="Ethan Ethan Ethan Ethan Ethan Johnson">
													Ethan Ethan Ethan Ethan Ethan Johnson
												</span>
											</div>
											<!-- Description -->
											<p class="card-text text-muted mb-3 small">
												Master advanced React concepts and patterns Master advanced React concepts
