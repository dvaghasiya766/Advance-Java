...
/**
 * Servlet implementation class UpdateStudentAvatar
 */
@WebServlet("/StudentPanel/UpdateStudentAvatar")
@MultipartConfig
public class UpdateStudentAvatar extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateStudentAvatar() {
        super();
